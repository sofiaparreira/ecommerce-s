    ...
    <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="mt-4 mb-5 flex items-center justify-between">
          <p><span className="text-2xl font-bold text-gray-700">R$ {preco.toFixed(2)}</span></p>
          <span className="mr-2 ml-3 rounded bg-sky-100 px-2.5 py-0.5 text-xs text-sky-700 font-semibold">{tipo}</span>
        </div>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-4 w-full max-w-lg">
            <div className="bg-white rounded-md shadow-lg px-4 py-6">
              ...
              <div className="mt-3 text-center sm:flex gap-2">
                <button className="w-full p-2.5 text-white bg-red-600 rounded-md" >Excluir</button>
                <button onClick={handleModalDelete} className="w-full p-2.5 text-gray-800 rounded-md border">Cancelar</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-4 w-full max-w-4xl">
            <div className="bg-white rounded-md shadow-lg px-6 py-6">
              ...
              <form className="mx-auto">
                ...
                <button type="submit" className="w-full p-2.5 text-white bg-orange-500 rounded-md">Salvar Alterações</button>
                <button onClick={handleModalEdit} className="w-full mt-2 p-2.5 text-gray-800 rounded-md border">Cancelar</button>
              </form>
            </div>
          </div>
        </div>
